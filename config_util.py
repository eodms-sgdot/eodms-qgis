...
class ConfigUtils:
    ...
    def __init__(self, eodms_plugin):
        ...
        self.eodms_plugin = eodms_plugin
    ...
    def _set_dict(self, dict_sect, sections, option):
        ...
        for sec in sections:
            self.eodms_plugin.post_message(f"sec: {sec}")
            self.eodms_plugin.post_message(f"option: {option}")
            self.eodms_plugin.post_message(self.config_info)
...
{opt_str}
    ...
    def get(self, section, option):
        ...
        self.eodms_plugin.post_message(f"self.config_dict: {self.config_dict}")
